...
//   // Initial load - only run when filteredMembers changes
//   useEffect(() => {
//     setVisibleMembers(filteredMembers.slice(0, itemsPerLoad));
//     setAllLoaded(filteredMembers.length <= itemsPerLoad);
//   }, [filteredMembers]);
...
//     // Simulate loading delay
//     setTimeout(() => {
//       const nextMembers = filteredMembers.slice(
//         visibleMembers.length,
//         visibleMembers.length + itemsPerLoad
//       );

//       setVisibleMembers((prev) => [...prev, ...nextMembers]);
//       setLoading(false);

//       if (
//         visibleMembers.length + nextMembers.length >=
...
//               onClick={() => handleMemberClick(member)}
//             >
//               <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-blue-100">
//                 <Image
//                   src={
//                     member.profilePicStatus === "approved" &&
//                     member.profilePicUrl
