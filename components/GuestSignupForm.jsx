...
function GuestSignupFormContent() {
  ...
  const isFormValid =
    waiverAgreement && (!includeDonation || (stripe && elements));
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 mt-2 mb-4">
        Use this form to sign up as a guest to play beach volleyball with us.
      </p>
      <p className="text-gray-700 mt-2 mb-4">
...
//       <h1 className="text-2xl font-bold">Guest Registration</h1>
//       <p className="text-gray-700 mt-2 mb-4">
//         Use this form to sign up as a guest to join us for our Pride Weekend.
//       </p>
//       <p className="text-gray-700 mt-2 mb-4">
//         If you'd like to become a regular member,{" "}
//         <Link href="/signup" className="text-blue-500">
...
//           {showFullWaiver && (
//             <div className="border-t pt-4 space-y-4 text-sm max-h-64 overflow-y-auto">
//               <div>
//                 <h4 className="font-bold text-base mb-2">Code of Conduct</h4>
//                 <p className="mb-3">
//                   Sandsharks is organized to be fun, safe, and welcoming to all
//                   LGBTQ+ people. We will not tolerate discrimination, hate
//                   speech, verbal or physical harassment of any kind.
//                 </p>
//               </div>
//               <div>
//                 <h4 className="font-bold text-base mb-2">Liability Waiver</h4>
//                 <p className="mb-3">
//                   By agreeing, I hereby release and forever discharge Toronto
//                   SandSharks from all liabilities and acknowledge the inherent
//                   risks of beach volleyball participation.
//                 </p>
//               </div>
//             </div>
//           )}
...
//           <h3 className="text-lg font-semibold mb-2">Optional Donation</h3>
//           <p className="text-sm text-gray-600 mb-3">
//             Help support Sandsharks with a voluntary donation. Your contribution
//             helps cover court rentals, equipment, and other expenses.
//           </p>
...
//                     />
//                   </div>
//                   <span className="text-sm text-gray-500">Suggested: $10</span>
//                 </div>
//               </div>
