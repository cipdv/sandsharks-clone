  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="bg-blue-100 p-6 rounded-md shadow-md">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-bold text-sandsharks-blue">
        ...
        <div className="mb-8">
          ...
          <p>
            Make sure to add this email address in your email's safe-senders
            list to get the updates:{" "}
          </p>
          <p>
            <span className="font-semibold">sandsharks@sandsharks.ca</span>
          </p>
        </div>
        ...
        {/* Confirmation Button - Updated to use ActionButton */}
        {!state.success && (
