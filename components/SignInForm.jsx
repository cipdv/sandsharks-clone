...
const SignInForm = ({ redirectTo, emailTarget }) => {
  ...
  const handleFormAction = async (formData) => {
    ...
    // If emailTarget exists, add it to the formData
    if (emailTarget) {
  ...
  return (
    ...
    >
      ...
      {/* If there's an emailTarget, add a hidden input to preserve it */}
      {emailTarget && (
        <input type="hidden" name="emailTarget" value={emailTarget} />
      )}
    </form>
  );
};
